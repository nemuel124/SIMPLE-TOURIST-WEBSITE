...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES["image"]["name"]) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
            ...
            $sql = "INSERT INTO images (image_name, image_location, image_path) VALUES ('$image_name', '$image_location', '$targetFilePath')";
...
<body>
    ...
    <h2>Add Destination</h2>
        <input type="text" name="image_name" placeholder="Destination Name" required><br><br>
        <input type="text" name="image_location" placeholder="Destination Location" required><br><br>
